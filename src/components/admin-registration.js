...
function AdminRegistrationForm(params) {
    ...
    if(params.register.firstName === "" ||
        ...
        //console.log("error");
        button = <Button onClick={validate} type="button" className="btn btn-primary">Add User</Button>;
    } else {
        //console.log("sending edit request");
        button =
            <Link to={"/system"}>
                <Button onClick={register} type="button" className="btn btn-primary">Add User</Button>
            </Link>;
...
export default connect(state2props)(AdminRegistrationForm);